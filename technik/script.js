...
async function loadProducts() {
    try {
        ...
        // NUR TECHNIK PRODUKTE
        allProducts = products.filter(p => p.category?.toLowerCase() === "technik");
...
function renderCurrentPage() {
    ...
    if (!filteredProducts.length) {
        grid.innerHTML = `<p class="text-center text-base-content/70 col-span-full">Keine Technik Angebote gefunden.</p>`;
        return;
    }
